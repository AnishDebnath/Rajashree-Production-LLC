...
const caseStudy: ProjectCaseStudy = {
    "objectives": [
        "Capture the energy, scale, and key moments of Innovatetech solutions's event through dynamic multi-camera coverage.",
    ...
    "scopes": [
        {
            ...
            "items": [
                "Coordinate with Innovatetech solutions's event team to map camera positions, run-of-show timing, and key moments to capture.",
...
const testimonials: Testimonial[] = [
    {
        "quote": "\"The team transformed our vision for TechConnect Expo 2023 into a stunning cinematic reality. Their attention to detail and creative passion exceeded every expectation we had.\"",
        "author": "INNOVATETECH SOLUTIONS",
        "role": "EXECUTIVE PRODUCER",
        "avatar": "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?auto=format&fit=crop&q=80&w=250"
    },
    {
        "quote": "\"Working with Rajashree Production on TechConnect Expo 2023 was an absolute pleasure. Their cinematography, sound design, and color grading are world-class — they made our brand look incredible.\"",
        "author": "HELENA MOSS",
        "role": "BRAND DIRECTOR",
        "avatar": "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&q=80&w=250"
    },
    {
        "quote": "\"From concept to delivery, every frame of TechConnect Expo 2023 was meticulously crafted. The production quality, pacing, and emotional depth far surpassed anything we imagined possible.\"",
        "author": "DEVON KOVACS",
...
const project: Project = {
    ...
    description: 'A pounding event recap capturing thousands of attendees engaged with interactive hardware playgrounds.',
    duration: '3m 00s',
    year: '2023',
    director: 'Farhan Akhtar',
    role: 'Live Capture & Editorial',
    credits: ['Director: Farhan Akhtar', 'DoP: Pooja Rao', 'Soundtrack: Arjun Mehta', 'VFX Intro: Aisha Sen'],
    introParagraph: 'Innovatetech solutions collaborated with our creative team to produce "TechConnect Expo 2023", a event project that blends cinematic craftsmanship with strategic storytelling to deliver a powerful, memorable visual experience.',
    caseStudy,
    testimonials,
    casting,
    gallery
