...
const caseStudy: ProjectCaseStudy = {
    "objectives": [
        "Capture the energy, scale, and key moments of Innovation inc.'s event through dynamic multi-camera coverage.",
    ...
    "scopes": [
        {
            ...
            "items": [
                "Coordinate with Innovation inc.'s event team to map camera positions, run-of-show timing, and key moments to capture.",
...
const testimonials: Testimonial[] = [
    {
        "quote": "\"The team transformed our vision for InnovateX Summit 2023 into a stunning cinematic reality. Their attention to detail and creative passion exceeded every expectation we had.\"",
        "author": "INNOVATION INC.",
        "role": "EXECUTIVE PRODUCER",
        "avatar": "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?auto=format&fit=crop&q=80&w=250"
    },
    {
        "quote": "\"Working with Rajashree Production on InnovateX Summit 2023 was an absolute pleasure. Their cinematography, sound design, and color grading are world-class — they made our brand look incredible.\"",
        "author": "HELENA MOSS",
        "role": "BRAND DIRECTOR",
        "avatar": "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&q=80&w=250"
    },
    {
        "quote": "\"From concept to delivery, every frame of InnovateX Summit 2023 was meticulously crafted. The production quality, pacing, and emotional depth far surpassed anything we imagined possible.\"",
        "author": "DEVON KOVACS",
...
const casting: CastingMember[] = [
    { role: 'Director', name: 'Nikhil Advani', avatar: '/src/assets/images/artist-vikram-roy.jpg' },
    { role: 'Technical Director', name: 'Vicky Shah', avatar: '/src/assets/images/artist-elina-roy.jpg' },
    { role: 'Live Sound', name: 'Amit Sharma', avatar: '/src/assets/images/artist-kabir-mehta.jpg' },
    { role: 'Social Media Editor', name: 'Divya Patel', avatar: '/src/assets/images/artist-sarah-sen.jpg' }
];
...
const project: Project = {
    id: '10',
    slug: 'innovatex-summit-2023',
    title: 'InnovateX Summit 2023',
    client: 'INNOVATION INC.',
    category: 'Event',
    image: '/src/assets/images/howrah-bridge-dusk.jpg',
    description: 'Multi-camera event capture documenting keynotes and live networking highlights of the Kolkata summit.',
    duration: '6m 12s',
    year: '2023',
    director: 'Nikhil Advani',
    role: 'Production Team',
    credits: ['Director: Nikhil Advani', 'Technical Director: Vicky Shah', 'Live Sound: Amit Sharma', 'Social Media Editor: Divya Patel'],
    introParagraph: 'Innovation inc. collaborated with our creative team to produce "InnovateX Summit 2023", a event project that blends cinematic craftsmanship with strategic storytelling to deliver a powerful, memorable visual experience.',
    caseStudy,
    testimonials,
    casting,
    gallery
