                ...
                <div className="flex flex-col gap-16 md:gap-24">
                    ...
                    {coreValues.map((item, idx) => (
                        ...
                        >
                            ...
                            <div className="font-display font-black text-8xl sm:text-9xl md:text-[10rem] lg:text-[11rem] text-[#141414] select-none pointer-events-none leading-none absolute -top-8 sm:-top-12 md:-top-16 left-0 transition-colors duration-300 group-hover:text-gold/[0.02]">
                                {item.num}
                            </div>
