...
interface CreativePlaygroundSectionProps {
    partners: Partner[];
}

export default function CreativePlaygroundSection({ partners }: CreativePlaygroundSectionProps) {
    return (
        <section className="relative py-24 z-10 bg-transparent" id="creative-playground">
            <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
                ...
                <div className="py-0 px-8 md:px-12 rounded-3xl bg-neutral-950/20 border border-white/5 shadow-2xl relative overflow-hidden">
                    ...
                    <div
                        className="grid grid-cols-2 sm:grid-cols-4 gap-x-8 h-[280px] overflow-hidden relative z-10"
                        style={{
