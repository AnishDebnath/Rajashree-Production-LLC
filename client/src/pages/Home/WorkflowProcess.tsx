                ...
                <div className="lg:col-span-7 space-y-6">
                    ...
                    >
                        <div className="space-y-3">
                            <h3 className="font-sans font-bold text-2xl sm:text-3xl text-white tracking-tight group-hover:text-gold transition-colors duration-200">Pre-Production</h3>
                            <div className="h-0.5 w-12 bg-gold" />
                            <p className="font-sans text-neutral-400 text-xs leading-relaxed pt-1">
                            ...
                            <span className="inline-flex items-center gap-1.5 font-sans font-bold text-[9px] tracking-wider uppercase text-gold group-hover:text-white transition-colors duration-200 pt-2">
                    ...
                    >
                        <div className="space-y-3">
                            <h3 className="font-sans font-bold text-2xl sm:text-3xl text-white tracking-tight group-hover:text-gold transition-colors duration-200">Production</h3>
                            <div className="h-0.5 w-12 bg-gold" />
                            <p className="font-sans text-neutral-400 text-xs leading-relaxed pt-1">
                    ...
                    >
                        <div className="space-y-3">
                            <h3 className="font-sans font-bold text-2xl sm:text-3xl text-white tracking-tight group-hover:text-gold transition-colors duration-200">Post-Production</h3>
                            <div className="h-0.5 w-12 bg-gold" />
                            <p className="font-sans text-neutral-400 text-xs leading-relaxed pt-1">
