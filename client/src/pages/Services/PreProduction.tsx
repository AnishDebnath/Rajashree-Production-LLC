...
import { preProductionItems, preProdMarqueeImages } from '../../data/services';
            ...
            <div className="max-w-6xl mx-auto bg-neutral-950/40 backdrop-blur-md rounded-3xl border border-white/10 p-6 sm:p-10 lg:p-14 space-y-12 shadow-2xl">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
                    ...
                    <div className="lg:col-span-5 space-y-6 lg:sticky lg:top-24">
                        ...
                        {/* Bottom marquee images in its previous position */}
                        <div className="relative overflow-hidden rounded-xl border border-white/5 shadow-2xl h-40 md:h-52 bg-[#050505]">
                            <div className="flex w-full h-full overflow-hidden select-none relative">
                                ...
                                >
                                    ...
                                    <div className="flex gap-3 shrink-0 h-full">
                                        {preProdMarqueeImages.map((img, idx) => (
                                            <div
                                                key={`set1-${idx}`}
                    ...
                    {/* Right Column: List of 7 Items with Thin Dividing Line */}
