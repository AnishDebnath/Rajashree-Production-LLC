    ...
    return (
        ...
        >
            ...
            >
                ...
                <h3 className="font-sans font-semibold text-lg sm:text-[19px] text-white group-hover:text-neutral-100 transition-colors tracking-tight mt-3 mb-2.5 leading-snug line-clamp-2">
                    {blog.title}
                </h3>
